      ...
      <section className="cta-section" id="waitlist">
        <div className="container animate">
          ...
          <form className="waitlist-form" onSubmit={handleWaitlist}>
            ...
            <input type="email" placeholder="you@email.com" aria-label="Email address" maxLength={254} value={email} onChange={e => setEmail(e.target.value)} required disabled={waitlistStatus === 'loading'} />
            <input type="tel" placeholder="Phone (optional)" aria-label="Phone number (optional)" maxLength={30} value={phone} onChange={e => setPhone(e.target.value)} disabled={waitlistStatus === 'loading'} style={{padding:'12px 16px',borderRadius:10,border:'1px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'#EDEDED',fontSize:'0.9rem',outline:'none',width:'100%',maxWidth:480,boxSizing:'border-box'}} />
